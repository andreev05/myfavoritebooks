...
describe Book do
  describe "search for similar books" do
    before :each do
      @book1 = FactoryBot.create(:book, title: 'It', author: 'Steven King')
      @book2 = FactoryBot.create(:book, title: 'The darker side', author: 'Steven King')
      @book3 = FactoryBot.create(:book, title: 'The Hobbit', author: 'Tolkien')
    end
